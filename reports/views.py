...
from maker.core.models import Object, Module
...
from maker.reports.forms import ObjChoiceForm, MassActionForm, ChartForm, FilterForm
from maker.reports.models import Report, Field, Model, Chart
from maker.reports.helpers import dumps, loads, aggregate_functions, number_field_regex
...
def _get_module_name(path):
    "Returns real and translated module name for the given path, e.g. Service Support for maker.services.models.Ticket"
    modulename = path
    try:
