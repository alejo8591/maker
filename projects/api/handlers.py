...
from maker.projects.models import Task, Project, Milestone, TaskStatus, TaskTimeSlot
from maker.projects.forms import ProjectForm, TaskForm, MilestoneForm, TaskStatusForm, TaskTimeSlotForm
...
class TaskStatusHandler(ObjectHandler):
    ...
    def check_create_permission(self, request, mode):
        return request.user.get_profile().is_admin('maker.projects')
