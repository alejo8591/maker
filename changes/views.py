...
from maker.core.decorators import handle_response_format, maker_login_required, module_admin_required
from maker.changes.forms import ChangeSetForm, ChangeSetStatusForm, FilterForm, SettingsForm, \
                                   MassActionForm
from maker.changes.models import ChangeSet, ChangeSetStatus
...
@handle_response_format
@maker_login_required
@module_admin_required('maker.changes')
...
def settings_view(request, response_format='html'):
    ...
    try:
        conf = ModuleSetting.get_for_module('maker.changes', 'default_changeset_status')[0]
