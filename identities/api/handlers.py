...
from maker.identities.models import ContactField, ContactType, Contact, ContactValue
from maker.identities.forms import ContactForm, FilterForm, ContactTypeForm, ContactFieldForm, MassActionForm
...
class ContactFieldHandler(ObjectHandler):
    ...
    def check_create_permission(self, request, mode):
        return request.user.get_profile().is_admin('maker.identities')
