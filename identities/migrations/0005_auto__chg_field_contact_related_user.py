...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('identities_contact', 'related_user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.InteractionEntity'], null=True, on_delete=models.SET_NULL))
    ...
    models = {
        ...
        'identities.contact': {
            ...
            'related_user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.InteractionEntity']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'})
        },
