...
from maker.account.forms import AccountForm, AccountPasswordForm, SettingsForm
from maker.core.decorators import maker_login_required, handle_response_format
from maker.core.models import ModuleSetting, Perspective
from maker.account.models import NotificationSetting
...
def settings_view(request, response_format='html'):
    ...
    # default perspective
    try:
        conf = ModuleSetting.get_for_module('maker.core', 'default_perspective', user=user)[0]
