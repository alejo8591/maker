...
from maker.account.models import NotificationSetting, notification_types
from maker.core.models import User, Object, ModuleSetting, Perspective, Module
...
class SettingsForm(forms.Form):
    ...
    def __init__(self, user, *args, **kwargs):
        ...
        try:
            conf = ModuleSetting.get_for_module('maker.core', 'default_perspective', user=self.user)[0]
