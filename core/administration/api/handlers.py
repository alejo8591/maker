...
from maker.core.api.handlers import AccessHandler, ObjectHandler
from maker.core.api.decorators import module_admin_required
from maker.core.models import User, Group, Perspective, Module, Page, PageFolder
from maker.core.administration.forms import PerspectiveForm, UserForm, GroupForm, PageForm, PageFolderForm
...
class PerspectiveHandler(ObjectHandler):
    ...
    def check_create_permission(self, request, mode):
        return request.user.get_profile().is_admin('maker.core')
    ...
    def delete_instance(self, request, inst):
        ...
        admin_module = Module.objects.all().filter(name='maker.core')[0]
