...
from maker.infrastructure.models import Item, ItemField, ItemType, ItemStatus, ItemServicing
from maker.infrastructure.forms import ItemForm, ItemTypeForm, ItemStatusForm, FilterForm, \
                                          MassActionForm, ItemFieldForm, ServiceRecordForm, SettingsForm
from maker.core.forms import LocationForm
from maker.core.models import Object, ModuleSetting, Location
...
@handle_response_format
@maker_login_required
@module_admin_required('maker.infrastructure')
