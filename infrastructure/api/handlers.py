...
from maker.core.models import Location
...
from maker.infrastructure.forms import ItemForm, ItemTypeForm, ItemStatusForm, ItemFieldForm, ServiceRecordForm

class InfrastructureCommonHandler(ObjectHandler):

    def check_create_permission(self, request, mode):
        return request.user.get_profile().is_admin('maker.infrastructure')
